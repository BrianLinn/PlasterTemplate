<
$manifestProperties = @{
    Path            = "C:\GIT\PlasterTemplate\PlasterManifest.xml"
...
$plaster = @{
    TemplatePath    = "C:\GIT\PlasterTemplate" #(Split-Path $manifestProperties.Path)
    DestinationPath = "C:\GIT\module"
    FullName = "Brian Monedero Linn"
